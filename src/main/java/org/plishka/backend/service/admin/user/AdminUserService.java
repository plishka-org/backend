...
public interface AdminUserService {
    PageResponse<AdminUserDto> getUsers(AdminUserSearchRequestDto request, int page, int size);

    PageResponse<AdminUserDto> getBannedUsers(AdminUserSearchRequestDto request, int page, int size);
